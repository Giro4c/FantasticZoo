...
public class Oviparous extends Creature {
	...
	public Egg layEgg() {
		if (!this.isMale()) {	
			...
			System.out.println("A " + this.getSpecie() + "layed an egg !");
			return new Egg(this.getSpecie(), "name", randomBoolean, randomWeight, randomheight, 0, "Full", false, "Perfect", 2, 0, this.enclosure);
		}
		return null;
	}
}
